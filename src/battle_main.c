...
{
    [TRAINER_CLASS_PKMN_TRAINER_1] = { _("{PKMN} Puppeteer") },
    [TRAINER_CLASS_PKMN_TRAINER_2] = { _("{PKMN} Puppeteer") },
    ...
    [TRAINER_CLASS_POKEMANIAC] = { _("Boné Maniac"), 15 },
    ...
    [TRAINER_CLASS_POKEFAN] = { _("Boné Fan"), 20 },
    ...
    [TRAINER_CLASS_RIVAL] = { _("{PKMN} Puppeteer"), 15 },
    ...
    [TRAINER_CLASS_RS_PROTAG] = { _("{PKMN} Puppeteer") },
};
