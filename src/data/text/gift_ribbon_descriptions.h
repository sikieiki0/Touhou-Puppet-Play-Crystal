...
const u8 gGiftRibbonDescriptionPart1_PokemonBattleCup[] = _("Bonéka BATTLE CUP");
const u8 gGiftRibbonDescriptionPart2_Participation[] = _("Participation RIBBON");
const u8 gGiftRibbonDescriptionPart1_PokemonLeague[] = _("Bonéka LEAGUE");
const u8 gGiftRibbonDescriptionPart1_AdvanceCup[] = _("ADVANCE CUP");
const u8 gGiftRibbonDescriptionPart1_PokemonTournament[] = _("Bonéka Tournament");
const u8 gGiftRibbonDescriptionPart2_Participation2[] = _("Participation RIBBON");
const u8 gGiftRibbonDescriptionPart1_PokemonEvent[] = _("Bonéka Event");
const u8 gGiftRibbonDescriptionPart1_PokemonFestival[] = _("Bonéka Festival");
...
const u8 gGiftRibbonDescriptionPart1_PokemonCenterTokyo[] = _("Bonéka CENTER TOKYO");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterOsaka[] = _("Bonéka CENTER OSAKA");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterNagoya[] = _("Bonéka CENTER NAGOYA");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterNY[] = _("Bonéka CENTER NY");
...
const u8 gGiftRibbonDescriptionPart2_LovedPokemon[] = _("for a loved Bonéka.");
const u8 gGiftRibbonDescriptionPart1_LoveForPokemon[] = _("RIBBON that shows");
const u8 gGiftRibbonDescriptionPart2_LoveForPokemon[] = _("love for Bonéka.");
