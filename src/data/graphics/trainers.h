...
const u16 gTrainerPalette_Renko[] = INCBIN_U16("graphics/trainers/front_pics/renko.gbapal");

const u32 gTrainerFrontPic_Merry[] = INCBIN_U32("graphics/trainers/front_pics/merry.4bpp.lz");
const u16 gTrainerPalette_Merry[] = INCBIN_U16("graphics/trainers/front_pics/merry.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_RENKO, gTrainerFrontPic_Renko, gTrainerPalette_Renko),
    TRAINER_SPRITE(TRAINER_PIC_MERRY, gTrainerFrontPic_Merry, gTrainerPalette_Merry),
};
...
{
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_BRENDAN, 5, gTrainerBackPic_Brendan, gTrainerPalette_Brendan, sBackAnims_Kanto),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_MAY, 5, gTrainerBackPic_May, gTrainerPalette_May, sBackAnims_Kanto),
