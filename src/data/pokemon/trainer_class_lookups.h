const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_RENKO] = TRAINER_PIC_RENKO,
    [FACILITY_CLASS_MERRY] = TRAINER_PIC_MERRY,
};
...
const enum TrainerClassID gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_RENKO] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_MERRY] = TRAINER_CLASS_RIVAL,
};
