...
// Type-boosting Held Items
    ...
    [ITEM_SILK_SCARF] =
    {
        .name = ITEM_NAME("Wedding Dress"),
        .pluralName = ITEM_PLURAL_NAME("Wedding Dresses"),
