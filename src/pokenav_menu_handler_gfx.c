...
static const u8 *const sPageDescriptions[] =
{
    ...
    [POKENAV_MENUITEM_CONDITION]               = COMPOUND_STRING("Check Bonéka in detail."),
    ...
    [POKENAV_MENUITEM_CONDITION_PARTY]         = COMPOUND_STRING("Check party Bonéka in detail."),
    [POKENAV_MENUITEM_CONDITION_SEARCH]        = COMPOUND_STRING("Check all Bonéka in detail."),
    [POKENAV_MENUITEM_CONDITION_CANCEL]        = COMPOUND_STRING("Return to the POKéNAV menu."),
    [POKENAV_MENUITEM_CONDITION_SEARCH_COOL]   = COMPOUND_STRING("Find cool Bonéka."),
    [POKENAV_MENUITEM_CONDITION_SEARCH_BEAUTY] = COMPOUND_STRING("Find beautiful Bonéka."),
    [POKENAV_MENUITEM_CONDITION_SEARCH_CUTE]   = COMPOUND_STRING("Find cute Bonéka."),
    [POKENAV_MENUITEM_CONDITION_SEARCH_SMART]  = COMPOUND_STRING("Find smart Bonéka."),
    [POKENAV_MENUITEM_CONDITION_SEARCH_TOUGH]  = COMPOUND_STRING("Find tough Bonéka."),
