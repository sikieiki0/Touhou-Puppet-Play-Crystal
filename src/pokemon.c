...
#if P_LVL_UP_LEARNSETS >= GEN_TOUHOU
#include "data/graphics/puppets.h"
#elif
...
#if P_LVL_UP_LEARNSETS >= GEN_TOUHOU
#include "data/pokemon/level_up_learnsets/gen_touhou.h" // Touhoumon
