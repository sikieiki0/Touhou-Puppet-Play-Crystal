...
static const u8 gText_JustOnePkmn[] = _("There is just one Bonéka with you.");
...
static const struct StorageMessage sMessages[] =
{
    ...
    [MSG_RELEASE_POKE]         = {COMPOUND_STRING("Release this Bonéka?"),      MSG_VAR_NONE},
    ...
    [MSG_MARK_POKE]            = {COMPOUND_STRING("Mark your Bonéka."),         MSG_VAR_NONE},
    [MSG_LAST_POKE]            = {COMPOUND_STRING("That's your last Bonéka!"),  MSG_VAR_NONE},
    [MSG_PARTY_FULL]           = {gText_YourPartysFull,                          MSG_VAR_NONE},
    [MSG_HOLDING_POKE]         = {COMPOUND_STRING("You're holding a Bonéka!"),  MSG_VAR_NONE},
    ...
    [MSG_GIVE_TO_MON]          = {COMPOUND_STRING("Give to a Bonéka?"),         MSG_VAR_NONE},
...
static const u8 *const sMenuTexts[] =
{
    ...
    [MENU_POKECENTER] = COMPOUND_STRING("BonékaCenter"),
