...
static const u8 gText_MatchCallBrendan_Pokemon[] = _("I will use various Bonéka.");
static const u8 gText_MatchCallBrendan_Intro1[] = _("I'll be a better Bonéka");
...
static const u8 gText_MatchCallMay_Pokemon[] = _("I'll use any Bonéka!");
static const u8 gText_MatchCallMay_Intro1[] = _("My Bonéka and I help");
