...
enum {
    ...
    MB_MT_PYRE_HOLE,
    MB_POND_WATER,
    MB_FAST_WATER, // Used by interior maps; functionally the same as MB_DEEP_WATER MB_INTERIOR_DEEP_WATER
    MB_DEEP_WATER,
    MB_WATERFALL,
    ...
    MB_NORTH_ARROW_WARP,
    MB_SOUTH_ARROW_WARP,
    MB_CRACKED_FLOOR_HOLE, // MB_FALL_WARP
    MB_REGULAR_WARP, // MB_AQUA_HIDEOUT_WARP
